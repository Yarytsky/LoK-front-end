...
import country from "../../img/icons/country.png"
            ...
            >
              {!this.state.successful && (
                <div id="formBlock">
                  <div className="row  justify-content-center ">
                    <div className="col-12 col-md-6 ">
                      <div className="row regLeft justify-content-center">
                        ...
                        <div className="input-group col-8">
                          <img className="icons" src={country} />
                          <select
                            list="Country"
                            type="text"
                  ...
                  <hr></hr>
                  <div className="row text-center"><a className="col-12 link">If you have an account</a></div>
                </div>
              )}
